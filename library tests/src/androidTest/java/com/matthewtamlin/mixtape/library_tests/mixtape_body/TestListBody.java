...
public class TestListBody extends TestRecyclerViewBody {
	@Rule
	private final ActivityTestRule<ListBodyTestHarness> rule =
			new ActivityTestRule<>(ListBodyTestHarness.class);

	private ListBody testViewDirect;
